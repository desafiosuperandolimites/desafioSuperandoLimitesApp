...
class ContatosPageAdmin extends StatefulWidget {
  const ContatosPageAdmin({super.key}); // Adicionando isAdminMode

  @override
  ContatosPageAdminState createState() => ContatosPageAdminState();
}

class ContatosPageAdminState extends State<ContatosPageAdmin> {
