...
class DadosAdicionaisPage extends StatefulWidget {
  const DadosAdicionaisPage({super.key}); // Adicionando isAdminMode);

  @override
  DadosAdicionaisPageState createState() => DadosAdicionaisPageState();
}

class DadosAdicionaisPageState extends State<DadosAdicionaisPage> {
      ...
      child: Column(
        ...
        children: <Widget>[
          CustomDropdownGrupo(
            ...
            onChanged: null, // Desabilita de modo permanente
            enabled: false, // Impede a interação do usuário
          ),
